...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tsuru_bind', (
            ...
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'binds', null=True, on_delete=models.PROTECT, to=orm['physical.Instance'])),
        ))
