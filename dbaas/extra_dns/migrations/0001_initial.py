...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'extra_dns.extradns': {
            'Meta': {'object_name': 'ExtraDns'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'database': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'extra_dns'", 'to': u"orm['logical.Database']"}),
