...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TaskHistory', fields ['database_name']
        db.create_index(u'notification_taskhistory', ['database_name'])


    def backwards(self, orm):
        # Removing index on 'TaskHistory', fields ['database_name']
        db.delete_index(u'notification_taskhistory', ['database_name'])
