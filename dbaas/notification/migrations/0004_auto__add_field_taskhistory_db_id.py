...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'notification_taskhistory', 'db_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'database', null=True, to=orm['logical.Database']),
                      keep_default=False)
    ...
    models = {
        ...
        u'notification.taskhistory': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'db_id': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'database'", 'null': 'True', 'to': u"orm['logical.Database']"}),
