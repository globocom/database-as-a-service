...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Credential.force_ssl'
        db.add_column(u'logical_credential', 'force_ssl',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Credential.force_ssl'
        db.delete_column(u'logical_credential', 'force_ssl')
