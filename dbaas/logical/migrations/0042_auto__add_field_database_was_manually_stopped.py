...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Database.was_manually_stopped'
        db.add_column(u'logical_database', 'was_manually_stopped',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Database.was_manually_stopped'
        db.delete_column(u'logical_database', 'was_manually_stopped')
    ...
    models = {
        ...
        u'logical.database': {
            ...
            'was_manually_stopped': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
