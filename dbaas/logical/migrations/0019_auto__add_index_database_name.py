...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Database', fields ['name']
        db.create_index(u'logical_database', ['name'])


    def backwards(self, orm):
        # Removing index on 'Database', fields ['name']
        db.delete_index(u'logical_database', ['name'])
