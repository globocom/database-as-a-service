...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'logical_database', 'is_in_quarantine')
    ...
    models = {
        ...
        u'logical.database': {
            ...
            'group': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "u'databases'", 'unique': 'True', 'null': 'True', 'to': u"orm['auth.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
