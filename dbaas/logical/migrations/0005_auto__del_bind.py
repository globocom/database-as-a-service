...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Bind'
        db.delete_table(u'logical_bind')


    def backwards(self, orm):
        # Adding model 'Bind'
        db.create_table(u'logical_bind', (
            ('service_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'binds', null=True, to=orm['physical.Instance'], on_delete=models.PROTECT, blank=True)),
            ('service_hostname', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'logical', ['Bind'])
