...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Database.is_protected'
        db.add_column(u'logical_database', 'is_protected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Database.is_protected'
        db.delete_column(u'logical_database', 'is_protected')
