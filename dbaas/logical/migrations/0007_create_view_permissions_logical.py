...
from logical.models import Database, Project, Credential
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        permission = Permission.objects.create(codename='view_database',
                                               name='Can view databases',
        ...
        permission = Permission.objects.create(codename='view_credential',
                                               name='Can view credentials',
                                               content_type=content_type)

    def backwards(self, orm):
        content_type = ContentType.objects.get_for_model(Database)
        permission = Permission.objects.get(codename='view_database',
                                               content_type=content_type)
        permission.delete()
        ...
        content_type = ContentType.objects.get_for_model(Credential)
        permission = Permission.objects.get(codename='view_credential',
                                               content_type=content_type)
        permission.delete()
