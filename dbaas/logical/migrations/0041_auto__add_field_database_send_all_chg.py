...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Database.send_all_chg'
        db.add_column(u'logical_database', 'send_all_chg',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Database.send_all_chg'
        db.delete_column(u'logical_database', 'send_all_chg')
