...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Database.product'
        db.alter_column(u'logical_database', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['logical.Product']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Database.product'
        raise RuntimeError("Cannot reverse this migration. 'Database.product' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Database.product'
        db.alter_column(u'logical_database', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['logical.Product']))
    ...
    models = {
        u'logical.bind': {
            ...
            'service_hostname': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
