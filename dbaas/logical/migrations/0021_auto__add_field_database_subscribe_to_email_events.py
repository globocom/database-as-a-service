...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Database.subscribe_to_email_events'
        db.add_column(u'logical_database', 'subscribe_to_email_events',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Database.subscribe_to_email_events'
        db.delete_column(u'logical_database', 'subscribe_to_email_events')
