...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DatabaseHistory.apps_bind_name'
        db.delete_column(u'logical_databasehistory', 'apps_bind_name')

        # Adding field 'Database.apps_bind_name'
        db.add_column(u'logical_database', 'apps_bind_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DatabaseHistory.apps_bind_name'
        db.add_column(u'logical_databasehistory', 'apps_bind_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Database.apps_bind_name'
        db.delete_column(u'logical_database', 'apps_bind_name')
    ...
    models = {
        ...
        u'physical.databaseinfra': {
            ...
            'disk_offering_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '4', 'related_name': "u'databaseinfras'", 'on_delete': 'models.DO_NOTHING', 'to': u"orm['physical.DiskOfferingType']"}),
        ...
        u'physical.plan': {
            ...
            'disk_offering_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '4', 'related_name': "u'plans'", 'on_delete': 'models.DO_NOTHING', 'to': u"orm['physical.DiskOfferingType']"}),
