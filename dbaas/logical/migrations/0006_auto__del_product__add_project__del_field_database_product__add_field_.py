...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('logical_product', 'logical_project')
        db.rename_column('logical_database', 'product_id', 'project_id')

    def backwards(self, orm):
        db.rename_table('logical_project', 'logical_product')
        db.rename_column('logical_database', 'project_id', 'product_id')
