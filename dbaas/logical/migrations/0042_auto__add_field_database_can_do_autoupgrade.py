...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Database.can_do_autoupgrade'
        db.add_column(u'logical_database', 'can_do_autoupgrade',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Database.can_do_autoupgrade'
        db.delete_column(u'logical_database', 'can_do_autoupgrade')
