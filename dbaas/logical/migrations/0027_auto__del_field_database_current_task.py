...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Database.current_task'
        db.delete_column(u'logical_database', 'current_task_id')


    def backwards(self, orm):
        # Adding field 'Database.current_task'
        db.add_column(u'logical_database', 'current_task',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database', null=True, to=orm['notification.TaskHistory'], blank=True),
                      keep_default=False)
