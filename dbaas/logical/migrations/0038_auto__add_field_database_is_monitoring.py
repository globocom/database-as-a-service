...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Database.is_monitoring'
        db.add_column(u'logical_database', 'is_monitoring',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Database.is_monitoring'
        db.delete_column(u'logical_database', 'is_monitoring')
