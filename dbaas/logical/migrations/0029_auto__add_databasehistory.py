...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseHistory'
        db.create_table(u'logical_databasehistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('database_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('environment', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ...
            ('databaseinfra_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('plan', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('disk_size_kb', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('has_persistence', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('deleted_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'logical', ['DatabaseHistory'])


    def backwards(self, orm):
        # Deleting model 'DatabaseHistory'
        db.delete_table(u'logical_databasehistory')
