...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Database.quarantine_user'
        db.add_column(u'logical_database', 'quarantine_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'databases_quarantine', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Database.quarantine_user'
        db.delete_column(u'logical_database', 'quarantine_user_id')
