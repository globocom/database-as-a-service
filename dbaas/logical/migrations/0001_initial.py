...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'logical_product', (
        ...
        db.send_create_signal(u'logical', ['Product'])
        ...
        db.create_table(u'logical_database', (
            ...
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases', on_delete=models.PROTECT, to=orm['physical.Instance'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases', on_delete=models.PROTECT, to=orm['logical.Product'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'logical_product')
    ...
    models = {
        ...
        u'logical.database': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'databases'", 'on_delete': 'models.PROTECT', 'to': u"orm['logical.Product']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'logical.product': {
