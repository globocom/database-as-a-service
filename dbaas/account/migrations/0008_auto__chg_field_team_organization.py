...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'account_team', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, on_delete=models.PROTECT, to=orm['account.Organization']))

    def backwards(self, orm):

        # Changing field 'Team.organization'
        db.alter_column(u'account_team', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.Organization'], on_delete=models.SET_NULL))
