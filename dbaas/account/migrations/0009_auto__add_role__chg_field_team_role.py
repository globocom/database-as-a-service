...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Role'
        db.create_table(u'account_role', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('group', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'role', unique=True, to=orm['auth.Group'])),
        ))
        db.send_create_signal(u'account', ['Role'])

        # Adding M2M table for field environments on 'Role'
        m2m_table_name = db.shorten_name(u'account_role_environments')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('role', models.ForeignKey(orm[u'account.role'], null=False)),
            ('environment', models.ForeignKey(orm[u'physical.environment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['role_id', 'environment_id'])


        # Changing field 'Team.role'
        db.alter_column(u'account_team', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Role']))

    def backwards(self, orm):
        # Deleting model 'Role'
        db.delete_table(u'account_role')

        # Removing M2M table for field environments on 'Role'
        db.delete_table(db.shorten_name(u'account_role_environments'))


        # Changing field 'Team.role'
        db.alter_column(u'account_team', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group']))
    ...
    models = {
        ...
        u'account.role': {
            ...
            'group': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "u'role'", 'unique': 'True', 'to': u"orm['auth.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'account.team': {
            ...
            'role': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.Role']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
