...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'account_organization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('grafana_orgid', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ...
        db.add_column(u'account_team', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'team_organization', null=True, on_delete=models.SET_NULL, to=orm['account.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Organization'
        db.delete_table(u'account_organization')

        # Deleting field 'Team.organization'
        db.delete_column(u'account_team', 'organization_id')
    ...
    models = {
        ...
        u'account.team': {
            ...
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'team_organization'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['account.Organization']"}),
