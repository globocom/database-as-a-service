...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.external'
        db.add_column(u'account_organization', 'external',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.external'
        db.delete_column(u'account_organization', 'external')
