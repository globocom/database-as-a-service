...
from ..models import Team, Role, User
...
class UserTest(TestCase):
    ...
    def setUp(self):
        ...
        self.team_dba = Team.objects.get_or_create(name="team_dba", role=self.role)[0]
        self.team_dev = Team.objects.get_or_create(name="team_dev", role=self.role)[0]
        self.team_ops = Team.objects.get_or_create(name="team_ops", role=self.role)[0]
        self.team_bkp = Team.objects.get_or_create(name="team_bkp", role=self.role)[0]
