...
class TaskSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = TaskHistory
        fields = ('id', 'task_id', 'task_status', 'db_id', 'object_class', 'object_id', 'updated_at', 'user', 'created_at')
...
class TaskAPI(viewsets.ReadOnlyModelViewSet):
    ...
    filter_fields = ('task_id', 'task_status', 'object_class', 'object_id', 'updated_at', 'created_at')
