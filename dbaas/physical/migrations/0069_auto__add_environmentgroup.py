...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EnvironmentGroup'
        db.create_table(u'physical_environmentgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'physical', ['EnvironmentGroup'])

        # Adding M2M table for field environments on 'EnvironmentGroup'
        m2m_table_name = db.shorten_name(u'physical_environmentgroup_environments')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('environmentgroup', models.ForeignKey(orm[u'physical.environmentgroup'], null=False)),
            ('environment', models.ForeignKey(orm[u'physical.environment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['environmentgroup_id', 'environment_id'])


    def backwards(self, orm):
        # Deleting model 'EnvironmentGroup'
        db.delete_table(u'physical_environmentgroup')

        # Removing M2M table for field environments on 'EnvironmentGroup'
        db.delete_table(db.shorten_name(u'physical_environmentgroup_environments'))
