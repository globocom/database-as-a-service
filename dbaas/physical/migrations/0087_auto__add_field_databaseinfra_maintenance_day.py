...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfra.maintenance_day'
        db.add_column(u'physical_databaseinfra', 'maintenance_day',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfra.maintenance_day'
        db.delete_column(u'physical_databaseinfra', 'maintenance_day')
