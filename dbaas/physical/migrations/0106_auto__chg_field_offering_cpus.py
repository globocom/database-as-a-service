...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offering.cpus'
        db.alter_column(u'physical_offering', 'cpus', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Offering.cpus'
        db.alter_column(u'physical_offering', 'cpus', self.gf('django.db.models.fields.IntegerField')())
