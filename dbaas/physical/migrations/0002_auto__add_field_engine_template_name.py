...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Engine.template_name'
        db.add_column(u'physical_engine', 'template_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Engine.template_name'
        db.delete_column(u'physical_engine', 'template_name')
