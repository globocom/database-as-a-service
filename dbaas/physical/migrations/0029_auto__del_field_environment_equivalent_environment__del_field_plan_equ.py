...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'physical_environment', 'equivalent_environment_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'physical_environment', 'equivalent_environment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['physical.Environment'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Plan.equivalent_plan'
        db.add_column(u'physical_plan', 'equivalent_plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['physical.Plan'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
