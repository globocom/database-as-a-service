...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Environment.location_description'
        db.add_column(u'physical_environment', 'location_description',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Environment.tsuru_deploy'
        db.add_column(u'physical_environment', 'tsuru_deploy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Environment.location_description'
        db.delete_column(u'physical_environment', 'location_description')

        # Deleting field 'Environment.tsuru_deploy'
        db.delete_column(u'physical_environment', 'tsuru_deploy')
