...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfra.disk_offering'
        db.add_column(u'physical_databaseinfra', 'disk_offering',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databaseinfras', null=True, on_delete=models.PROTECT, to=orm['physical.DiskOffering']),
                      keep_default=False)

        # Adding field 'Plan.disk_offering'
        db.add_column(u'physical_plan', 'disk_offering',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'plans', null=True, on_delete=models.PROTECT, to=orm['physical.DiskOffering']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfra.disk_offering'
        db.delete_column(u'physical_databaseinfra', 'disk_offering_id')

        # Deleting field 'Plan.disk_offering'
        db.delete_column(u'physical_plan', 'disk_offering_id')
