...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Environment.min_of_zones'
        db.add_column(u'physical_environment', 'min_of_zones',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Environment.min_of_zones'
        db.delete_column(u'physical_environment', 'min_of_zones')
