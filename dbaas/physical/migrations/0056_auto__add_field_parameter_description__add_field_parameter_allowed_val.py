...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'physical_parameter', 'parameter_type',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'physical_parameter', 'description')

        # Deleting field 'Parameter.allowed_values'
        db.delete_column(u'physical_parameter', 'allowed_values')

        # Deleting field 'Parameter.parameter_type'
        db.delete_column(u'physical_parameter', 'parameter_type')
