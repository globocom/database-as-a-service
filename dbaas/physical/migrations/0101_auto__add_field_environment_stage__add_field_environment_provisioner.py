...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Environment.stage'
        db.add_column(u'physical_environment', 'stage',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Environment.provisioner'
        db.add_column(u'physical_environment', 'provisioner',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Environment.stage'
        db.delete_column(u'physical_environment', 'stage')

        # Deleting field 'Environment.provisioner'
        db.delete_column(u'physical_environment', 'provisioner')
