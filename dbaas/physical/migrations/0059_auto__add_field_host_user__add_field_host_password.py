...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'physical_host', 'user',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Host.password'
        db.add_column(u'physical_host', 'password',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'physical_host', 'user')

        # Deleting field 'Host.password'
        db.delete_column(u'physical_host', 'password')
