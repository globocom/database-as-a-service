...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.temporary'
        db.add_column(u'physical_instance', 'temporary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.temporary'
        db.delete_column(u'physical_instance', 'temporary')
