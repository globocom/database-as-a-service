...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field environments on 'DiskOffering'
        m2m_table_name = db.shorten_name(u'physical_diskoffering_environments')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('diskoffering', models.ForeignKey(orm[u'physical.diskoffering'], null=False)),
            ('environment', models.ForeignKey(orm[u'physical.environment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['diskoffering_id', 'environment_id'])


    def backwards(self, orm):
        # Removing M2M table for field environments on 'DiskOffering'
        db.delete_table(db.shorten_name(u'physical_diskoffering_environments'))
