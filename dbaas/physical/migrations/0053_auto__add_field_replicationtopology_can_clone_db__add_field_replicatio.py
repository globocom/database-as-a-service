...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReplicationTopology.can_clone_db'
        db.add_column(u'physical_replicationtopology', 'can_clone_db',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ReplicationTopology.can_switch_master'
        db.add_column(u'physical_replicationtopology', 'can_switch_master',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ReplicationTopology.can_upgrade_db'
        db.add_column(u'physical_replicationtopology', 'can_upgrade_db',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ReplicationTopology.can_change_parameters'
        db.add_column(u'physical_replicationtopology', 'can_change_parameters',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReplicationTopology.can_clone_db'
        db.delete_column(u'physical_replicationtopology', 'can_clone_db')

        # Deleting field 'ReplicationTopology.can_switch_master'
        db.delete_column(u'physical_replicationtopology', 'can_switch_master')

        # Deleting field 'ReplicationTopology.can_upgrade_db'
        db.delete_column(u'physical_replicationtopology', 'can_upgrade_db')

        # Deleting field 'ReplicationTopology.can_change_parameters'
        db.delete_column(u'physical_replicationtopology', 'can_change_parameters')
