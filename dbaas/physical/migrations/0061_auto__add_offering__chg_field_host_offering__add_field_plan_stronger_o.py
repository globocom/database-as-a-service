...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'physical_offering', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('cpus', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('memory_size_mb', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('environment', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'offerings', to=orm['physical.Environment'])),
        ))
        db.send_create_signal(u'physical', ['Offering'])


        # Changing field 'Host.offering'
        db.alter_column(u'physical_host', 'offering_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['physical.Offering'], null=True))
        # Adding field 'Plan.stronger_offering'
        db.add_column(u'physical_plan', 'stronger_offering',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'main_offerings', null=True, to=orm['physical.Offering']),
                      keep_default=False)

        # Adding field 'Plan.weaker_offering'
        db.add_column(u'physical_plan', 'weaker_offering',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'weaker_offerings', null=True, to=orm['physical.Offering']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Offering'
        db.delete_table(u'physical_offering')


        # Changing field 'Host.offering'
        db.alter_column(u'physical_host', 'offering_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbaas_cloudstack.CloudStackOffering'], null=True))
        # Deleting field 'Plan.stronger_offering'
        db.delete_column(u'physical_plan', 'stronger_offering_id')

        # Deleting field 'Plan.weaker_offering'
        db.delete_column(u'physical_plan', 'weaker_offering_id')
