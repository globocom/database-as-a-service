...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfra.backup_hour'
        db.add_column(u'physical_databaseinfra', 'backup_hour',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfra.backup_hour'
        db.delete_column(u'physical_databaseinfra', 'backup_hour')
