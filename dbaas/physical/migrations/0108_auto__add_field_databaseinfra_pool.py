...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfra.pool'
        db.add_column(u'physical_databaseinfra', 'pool',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'infra', null=True, to=orm['physical.Pool']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfra.pool'
        db.delete_column(u'physical_databaseinfra', 'pool_id')
