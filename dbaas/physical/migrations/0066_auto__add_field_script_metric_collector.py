...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Script.metric_collector'
        db.add_column(u'physical_script', 'metric_collector',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Script.metric_collector'
        db.delete_column(u'physical_script', 'metric_collector')
