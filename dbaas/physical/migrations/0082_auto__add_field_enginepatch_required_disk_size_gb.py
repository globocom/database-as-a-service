...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnginePatch.required_disk_size_gb'
        db.add_column(u'physical_enginepatch', 'required_disk_size_gb',
                      self.gf('django.db.models.fields.FloatField')(default=8.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnginePatch.required_disk_size_gb'
        db.delete_column(u'physical_enginepatch', 'required_disk_size_gb')
    ...
    models = {
        ...
        u'physical.enginepatch': {
            ...
            'required_disk_size_gb': ('django.db.models.fields.FloatField', [], {}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
