...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DiskOfferingType.identifier'
        db.alter_column(u'physical_diskofferingtype', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Plan.disk_offering_type'
        db.alter_column(u'physical_plan', 'disk_offering_type_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.DO_NOTHING, to=orm['physical.DiskOfferingType']))

        # Changing field 'DatabaseInfra.disk_offering_type'
        db.alter_column(u'physical_databaseinfra', 'disk_offering_type_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.DO_NOTHING, to=orm['physical.DiskOfferingType']))

    def backwards(self, orm):

        # Changing field 'DiskOfferingType.identifier'
        db.alter_column(u'physical_diskofferingtype', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Plan.disk_offering_type'
        db.alter_column(u'physical_plan', 'disk_offering_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['physical.DiskOfferingType'], on_delete=models.DO_NOTHING))

        # Changing field 'DatabaseInfra.disk_offering_type'
        db.alter_column(u'physical_databaseinfra', 'disk_offering_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['physical.DiskOfferingType'], on_delete=models.DO_NOTHING))
    ...
    models = {
        ...
        u'physical.databaseinfra': {
            ...
            'disk_offering_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'databaseinfras'", 'on_delete': 'models.DO_NOTHING', 'to': u"orm['physical.DiskOfferingType']"}),
        ...
        u'physical.plan': {
            ...
            'disk_offering_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'plans'", 'on_delete': 'models.DO_NOTHING', 'to': u"orm['physical.DiskOfferingType']"}),
