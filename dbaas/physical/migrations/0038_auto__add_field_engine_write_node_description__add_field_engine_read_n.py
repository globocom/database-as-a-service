...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Engine.write_node_description'
        db.add_column(u'physical_engine', 'write_node_description',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Engine.read_node_description'
        db.add_column(u'physical_engine', 'read_node_description',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Engine.write_node_description'
        db.delete_column(u'physical_engine', 'write_node_description')

        # Deleting field 'Engine.read_node_description'
        db.delete_column(u'physical_engine', 'read_node_description')
