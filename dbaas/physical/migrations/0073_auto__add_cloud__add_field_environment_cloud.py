...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cloud'
        db.create_table(u'physical_cloud', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'physical', ['Cloud'])

        # Adding field 'Environment.cloud'
        db.add_column(u'physical_environment', 'cloud',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'environment_cloud', on_delete=models.PROTECT, to=orm['physical.Cloud']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Cloud'
        db.delete_table(u'physical_cloud')

        # Deleting field 'Environment.cloud'
        db.delete_column(u'physical_environment', 'cloud_id')
