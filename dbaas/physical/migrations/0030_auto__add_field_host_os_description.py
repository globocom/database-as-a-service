...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.os_description'
        db.add_column(u'physical_host', 'os_description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.os_description'
        db.delete_column(u'physical_host', 'os_description')
