...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Environment.hide_migration'
        db.add_column(u'physical_environment', 'hide_migration',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Environment.hide_migration'
        db.delete_column(u'physical_environment', 'hide_migration')
