...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReplicationTopology.details'
        db.add_column(u'physical_replicationtopology', 'details',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReplicationTopology.details'
        db.delete_column(u'physical_replicationtopology', 'details')
