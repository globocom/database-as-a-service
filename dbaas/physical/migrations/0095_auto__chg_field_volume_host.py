...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Volume.host'
        db.alter_column(u'physical_volume', 'host_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['physical.Host']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Volume.host'
        raise RuntimeError("Cannot reverse this migration. 'Volume.host' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Volume.host'
        db.alter_column(u'physical_volume', 'host_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['physical.Host']))
