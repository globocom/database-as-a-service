...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'physical_enginepatch', 'migrate_engine_equivalent_patch',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'backwards_engine_patch', null=True, on_delete=models.SET_NULL, to=orm['physical.EnginePatch']),
                      keep_default=False)
    ...
    models = {
        ...
        u'physical.enginepatch': {
            ...
            'migrate_engine_equivalent_patch': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'backwards_engine_patch'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.EnginePatch']"}),
