...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnginePatch.patch_path_ol7'
        db.add_column(u'physical_enginepatch', 'patch_path_ol7',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnginePatch.patch_path_ol7'
        db.delete_column(u'physical_enginepatch', 'patch_path_ol7')
