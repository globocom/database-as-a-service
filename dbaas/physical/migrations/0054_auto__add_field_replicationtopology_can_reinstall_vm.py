...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReplicationTopology.can_reinstall_vm'
        db.add_column(u'physical_replicationtopology', 'can_reinstall_vm',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReplicationTopology.can_reinstall_vm'
        db.delete_column(u'physical_replicationtopology', 'can_reinstall_vm')
