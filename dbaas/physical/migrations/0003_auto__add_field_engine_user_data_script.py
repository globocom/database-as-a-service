...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Engine.user_data_script'
        db.add_column(u'physical_engine', 'user_data_script',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Engine.user_data_script'
        db.delete_column(u'physical_engine', 'user_data_script')
