...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vip.backend_service'
        db.add_column(u'physical_vip', 'backend_service',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vip.backend_service'
        db.delete_column(u'physical_vip', 'backend_service')
