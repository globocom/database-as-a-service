...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.cloud_portal_host'
        db.add_column(u'physical_host', 'cloud_portal_host',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.cloud_portal_host'
        db.delete_column(u'physical_host', 'cloud_portal_host')
    ...
    models = {
        ...
        u'physical.host': {
            ...
            'cloud_portal_host': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'cp_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
