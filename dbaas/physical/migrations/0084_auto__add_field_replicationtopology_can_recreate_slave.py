...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReplicationTopology.can_recreate_slave'
        db.add_column(u'physical_replicationtopology', 'can_recreate_slave',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReplicationTopology.can_recreate_slave'
        db.delete_column(u'physical_replicationtopology', 'can_recreate_slave')
