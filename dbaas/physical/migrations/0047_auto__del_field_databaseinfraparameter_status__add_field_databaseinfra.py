...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DatabaseInfraParameter.status'
        db.delete_column(u'physical_databaseinfraparameter', 'status')

        # Adding field 'DatabaseInfraParameter.current_value'
        db.add_column(u'physical_databaseinfraparameter', 'current_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'DatabaseInfraParameter.applied_on_database'
        db.add_column(u'physical_databaseinfraparameter', 'applied_on_database',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DatabaseInfraParameter.reset_default_value'
        db.add_column(u'physical_databaseinfraparameter', 'reset_default_value',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DatabaseInfraParameter.status'
        db.add_column(u'physical_databaseinfraparameter', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'DatabaseInfraParameter.current_value'
        db.delete_column(u'physical_databaseinfraparameter', 'current_value')

        # Deleting field 'DatabaseInfraParameter.applied_on_database'
        db.delete_column(u'physical_databaseinfraparameter', 'applied_on_database')

        # Deleting field 'DatabaseInfraParameter.reset_default_value'
        db.delete_column(u'physical_databaseinfraparameter', 'reset_default_value')
