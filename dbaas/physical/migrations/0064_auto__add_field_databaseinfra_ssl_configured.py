...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfra.ssl_configured'
        db.add_column(u'physical_databaseinfra', 'ssl_configured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfra.ssl_configured'
        db.delete_column(u'physical_databaseinfra', 'ssl_configured')
