...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfra.service_account'
        db.add_column(u'physical_databaseinfra', 'service_account',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfra.service_account'
        db.delete_column(u'physical_databaseinfra', 'service_account')
