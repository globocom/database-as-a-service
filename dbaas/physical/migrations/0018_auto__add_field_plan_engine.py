...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plan.engine'
        db.add_column(u'physical_plan', 'engine',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name=u'plans', to=orm['physical.Engine']),
                      keep_default=False)

        sql_migration_file = "{}/migration_0018_up.sql".format(
            abspath(dirname(__file__)))
        db.execute(open(sql_migration_file).read())

    def backwards(self, orm):
        # Deleting field 'Plan.engine'
        db.delete_column(u'physical_plan', 'engine_id')
