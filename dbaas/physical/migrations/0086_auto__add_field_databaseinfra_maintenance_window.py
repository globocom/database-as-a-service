...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfra.maintenance_window'
        db.add_column(u'physical_databaseinfra', 'maintenance_window',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfra.maintenance_window'
        db.delete_column(u'physical_databaseinfra', 'maintenance_window')
