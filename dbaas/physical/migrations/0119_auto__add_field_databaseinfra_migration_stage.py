...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfra.migration_stage'
        db.add_column(u'physical_databaseinfra', 'migration_stage',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfra.migration_stage'
        db.delete_column(u'physical_databaseinfra', 'migration_stage')
