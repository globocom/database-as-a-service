...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfra.maintenance_hour'
        db.add_column(u'physical_databaseinfra', 'maintenance_hour',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfra.maintenance_hour'
        db.delete_column(u'physical_databaseinfra', 'maintenance_hour')
