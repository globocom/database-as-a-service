...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReplicationTopology'
        db.create_table(u'physical_replicationtopology', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('class_path', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'physical', ['ReplicationTopology'])

        # Adding M2M table for field engine on 'ReplicationTopology'
        m2m_table_name = db.shorten_name(u'physical_replicationtopology_engine')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('replicationtopology', models.ForeignKey(orm[u'physical.replicationtopology'], null=False)),
            ('engine', models.ForeignKey(orm[u'physical.engine'], null=False))
        ))
        db.create_unique(m2m_table_name, ['replicationtopology_id', 'engine_id'])

        # Adding field 'Plan.replication_topology'
        db.add_column(u'physical_plan', 'replication_topology',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'replication_topology', null=True, to=orm['physical.ReplicationTopology']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ReplicationTopology'
        db.delete_table(u'physical_replicationtopology')

        # Removing M2M table for field engine on 'ReplicationTopology'
        db.delete_table(db.shorten_name(u'physical_replicationtopology_engine'))

        # Deleting field 'Plan.replication_topology'
        db.delete_column(u'physical_plan', 'replication_topology_id')
