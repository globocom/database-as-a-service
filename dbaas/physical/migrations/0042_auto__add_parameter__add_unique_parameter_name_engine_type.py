...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'physical_parameter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('engine_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'enginetype', on_delete=models.PROTECT, to=orm['physical.EngineType'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('dynamic', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('class_path', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'physical', ['Parameter'])

        # Adding unique constraint on 'Parameter', fields ['name', 'engine_type']
        db.create_unique(u'physical_parameter', ['name', 'engine_type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Parameter', fields ['name', 'engine_type']
        db.delete_unique(u'physical_parameter', ['name', 'engine_type_id'])

        # Deleting model 'Parameter'
        db.delete_table(u'physical_parameter')
