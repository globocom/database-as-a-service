...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pool.cluster_name'
        db.add_column(u'physical_pool', 'cluster_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Pool.rancher_token'
        db.add_column(u'physical_pool', 'rancher_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=406, blank=True),
                      keep_default=False)

        # Adding field 'Pool.dbaas_token'
        db.add_column(u'physical_pool', 'dbaas_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=406, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Pool.cluster_name'
        db.delete_column(u'physical_pool', 'cluster_name')

        # Deleting field 'Pool.rancher_token'
        db.delete_column(u'physical_pool', 'rancher_token')

        # Deleting field 'Pool.dbaas_token'
        db.delete_column(u'physical_pool', 'dbaas_token')
    ...
    models = {
        ...
        u'physical.pool': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dbaas_token': ('django.db.models.fields.CharField', [], {'max_length': '406', 'blank': 'True'}),
            ...
            'rancher_token': ('django.db.models.fields.CharField', [], {'max_length': '406', 'blank': 'True'}),
