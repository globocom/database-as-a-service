...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReplicationTopology.has_horizontal_scalability'
        db.add_column(u'physical_replicationtopology', 'has_horizontal_scalability',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReplicationTopology.has_horizontal_scalability'
        db.delete_column(u'physical_replicationtopology', 'has_horizontal_scalability')
