...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Parameter.config_name'
        db.add_column(u'physical_parameter', 'config_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Parameter.config_name'
        db.delete_column(u'physical_parameter', 'config_name')
    ...
    models = {
        ...
        u'physical.parameter': {
            ...
            'config_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
