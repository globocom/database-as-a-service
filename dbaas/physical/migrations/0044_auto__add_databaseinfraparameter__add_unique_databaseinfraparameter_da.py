...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseInfraParameter'
        db.create_table(u'physical_databaseinfraparameter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('databaseinfra', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['physical.DatabaseInfra'])),
            ('parameter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['physical.Parameter'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'physical', ['DatabaseInfraParameter'])

        # Adding unique constraint on 'DatabaseInfraParameter', fields ['databaseinfra', 'parameter']
        db.create_unique(u'physical_databaseinfraparameter', ['databaseinfra_id', 'parameter_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DatabaseInfraParameter', fields ['databaseinfra', 'parameter']
        db.delete_unique(u'physical_databaseinfraparameter', ['databaseinfra_id', 'parameter_id'])

        # Deleting model 'DatabaseInfraParameter'
        db.delete_table(u'physical_databaseinfraparameter')
