...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volume.total_size_kb'
        db.add_column(u'physical_volume', 'total_size_kb',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Volume.total_size_kb'
        db.delete_column(u'physical_volume', 'total_size_kb')
