...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfra.database_key'
        db.add_column(u'physical_databaseinfra', 'database_key',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfra.database_key'
        db.delete_column(u'physical_databaseinfra', 'database_key')
