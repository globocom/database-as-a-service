...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReplicationTopology.can_setup_ssl'
        db.add_column(u'physical_replicationtopology', 'can_setup_ssl',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReplicationTopology.can_setup_ssl'
        db.delete_column(u'physical_replicationtopology', 'can_setup_ssl')
