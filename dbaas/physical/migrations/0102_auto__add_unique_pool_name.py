...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Pool', fields ['name']
        db.create_unique(u'physical_pool', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Pool', fields ['name']
        db.delete_unique(u'physical_pool', ['name'])
