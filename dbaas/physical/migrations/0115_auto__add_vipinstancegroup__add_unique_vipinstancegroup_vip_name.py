...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VipInstanceGroup'
        db.create_table(u'physical_vipinstancegroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('vip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['physical.Vip'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('identifier', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'physical', ['VipInstanceGroup'])

        # Adding unique constraint on 'VipInstanceGroup', fields ['vip', 'name']
        db.create_unique(u'physical_vipinstancegroup', ['vip_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'VipInstanceGroup', fields ['vip', 'name']
        db.delete_unique(u'physical_vipinstancegroup', ['vip_id', 'name'])

        # Deleting model 'VipInstanceGroup'
        db.delete_table(u'physical_vipinstancegroup')
