...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pool'
        db.create_table(u'physical_pool', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('environment', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'pools', to=orm['physical.Environment'])),
            ('config', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=406, blank=True)),
            ('secret', self.gf('django.db.models.fields.CharField')(max_length=406, blank=True)),
        ))
        db.send_create_signal(u'physical', ['Pool'])

        # Adding M2M table for field teams on 'Pool'
        m2m_table_name = db.shorten_name(u'physical_pool_teams')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pool', models.ForeignKey(orm[u'physical.pool'], null=False)),
            ('team', models.ForeignKey(orm[u'account.team'], null=False))
        ))
        db.create_unique(m2m_table_name, ['pool_id', 'team_id'])


    def backwards(self, orm):
        # Deleting model 'Pool'
        db.delete_table(u'physical_pool')

        # Removing M2M table for field teams on 'Pool'
        db.delete_table(db.shorten_name(u'physical_pool_teams'))
