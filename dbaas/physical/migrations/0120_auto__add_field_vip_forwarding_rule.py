...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vip.forwarding_rule'
        db.add_column(u'physical_vip', 'forwarding_rule',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vip.forwarding_rule'
        db.delete_column(u'physical_vip', 'forwarding_rule')
    ...
    models = {
        ...
        u'physical.vip': {
            ...
            'backend_service': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '60', 'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'forwarding_rule': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '60', 'null': 'True'}),
            'healthcheck': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '60', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
