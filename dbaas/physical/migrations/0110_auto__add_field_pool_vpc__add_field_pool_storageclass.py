...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pool.vpc'
        db.add_column(u'physical_pool', 'vpc',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Pool.storageclass'
        db.add_column(u'physical_pool', 'storageclass',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pool.vpc'
        db.delete_column(u'physical_pool', 'vpc')

        # Deleting field 'Pool.storageclass'
        db.delete_column(u'physical_pool', 'storageclass')
