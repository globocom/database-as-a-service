...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vip.url_map'
        db.add_column(u'physical_vip', 'url_map',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vip.url_map'
        db.delete_column(u'physical_vip', 'url_map')
    ...
    models = {
        ...
        u'physical.vip': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_map': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '60', 'null': 'True'})
        },
