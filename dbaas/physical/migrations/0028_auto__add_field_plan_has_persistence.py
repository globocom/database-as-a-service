...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plan.has_persistence'
        db.add_column(u'physical_plan', 'has_persistence',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plan.has_persistence'
        db.delete_column(u'physical_plan', 'has_persistence')
