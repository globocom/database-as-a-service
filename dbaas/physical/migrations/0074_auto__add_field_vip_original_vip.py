...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vip.original_vip'
        db.add_column(u'physical_vip', 'original_vip',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['physical.Vip'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vip.original_vip'
        db.delete_column(u'physical_vip', 'original_vip_id')
