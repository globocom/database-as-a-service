...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Host.ssl_expire_at'
        db.add_column(u'physical_host', 'ssl_expire_at',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Host.ssl_expire_at'
        db.delete_column(u'physical_host', 'ssl_expire_at')
