...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Instance.is_arbiter'
        db.delete_column(u'physical_instance', 'is_arbiter')


    def backwards(self, orm):
        # Adding field 'Instance.is_arbiter'
        db.add_column(u'physical_instance', 'is_arbiter',
