...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EngineType.is_in_memory'
        db.add_column(u'physical_enginetype', 'is_in_memory',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EngineType.is_in_memory'
        db.delete_column(u'physical_enginetype', 'is_in_memory')
