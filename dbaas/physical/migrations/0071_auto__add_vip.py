...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Vip'
        db.create_table(u'physical_vip', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('infra', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'vips', to=orm['physical.DatabaseInfra'])),
            ('identifier', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'physical', ['Vip'])


    def backwards(self, orm):
        # Deleting model 'Vip'
        db.delete_table(u'physical_vip')
