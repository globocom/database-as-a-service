...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DiskOfferingType'
        db.create_table(u'physical_diskofferingtype', (
        ...
        db.send_create_signal(u'physical', ['DiskOfferingType'])

        # Adding M2M table for field environments on 'DiskOfferingType'
        m2m_table_name = db.shorten_name(u'physical_diskofferingtype_environments')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('diskofferingtype', models.ForeignKey(orm[u'physical.diskofferingtype'], null=False)),
            ('environment', models.ForeignKey(orm[u'physical.environment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['diskofferingtype_id', 'environment_id'])

        # Adding field 'Volume.disk_offering_type'
        db.add_column(u'physical_volume', 'disk_offering_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plan.disk_offering_type'
        db.add_column(u'physical_plan', 'disk_offering_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'plans', null=True, on_delete=models.DO_NOTHING, to=orm['physical.DiskOfferingType']),
                      keep_default=False)

        # Adding field 'DatabaseInfra.disk_offering_type'
        db.add_column(u'physical_databaseinfra', 'disk_offering_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'databaseinfras', null=True, on_delete=models.DO_NOTHING, to=orm['physical.DiskOfferingType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DiskOfferingType'
        db.delete_table(u'physical_diskofferingtype')

        # Removing M2M table for field environments on 'DiskOfferingType'
        db.delete_table(db.shorten_name(u'physical_diskofferingtype_environments'))

        # Deleting field 'Volume.disk_offering_type'
        db.delete_column(u'physical_volume', 'disk_offering_type')

        # Deleting field 'Plan.disk_offering_type'
        db.delete_column(u'physical_plan', 'disk_offering_type_id')

        # Deleting field 'DatabaseInfra.disk_offering_type'
        db.delete_column(u'physical_databaseinfra', 'disk_offering_type_id')
