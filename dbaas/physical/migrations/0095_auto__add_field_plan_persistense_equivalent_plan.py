...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plan.persistense_equivalent_plan'
        db.add_column(u'physical_plan', 'persistense_equivalent_plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'backwards_persisted_plan', null=True, on_delete=models.SET_NULL, to=orm['physical.Plan']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plan.persistense_equivalent_plan'
        db.delete_column(u'physical_plan', 'persistense_equivalent_plan_id')
