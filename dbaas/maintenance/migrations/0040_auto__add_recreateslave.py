...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecreateSlave'
        db.create_table(u'maintenance_recreateslave', (
            ...
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'recreate_slave', to=orm['notification.TaskHistory'])),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'recreate_slave', to=orm['physical.Host'])),
            ('snapshot', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'snapshot_recreate_slave', null=True, to=orm['backup.Snapshot'])),
        ))
        db.send_create_signal(u'maintenance', ['RecreateSlave'])


    def backwards(self, orm):
        # Deleting model 'RecreateSlave'
        db.delete_table(u'maintenance_recreateslave')
