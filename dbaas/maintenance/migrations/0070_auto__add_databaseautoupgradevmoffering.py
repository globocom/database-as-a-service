...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseAutoUpgradeVMOffering'
        db.create_table(u'maintenance_databaseautoupgradevmoffering', (
            ...
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databaseautoupgradevmoffering_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('current_step_class', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'auto_upgrade_vm_offering', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_auto_upgrade_vm_offering', to=orm['notification.TaskHistory'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseAutoUpgradeVMOffering'])


    def backwards(self, orm):
        # Deleting model 'DatabaseAutoUpgradeVMOffering'
        db.delete_table(u'maintenance_databaseautoupgradevmoffering')
    ...
    models = {
        ...
        u'maintenance.databaseautoupgradevmoffering': {
            ...
            'current_step': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'current_step_class': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'database': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'auto_upgrade_vm_offering'", 'to': u"orm['logical.Database']"}),
            'finished_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'started_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'database_auto_upgrade_vm_offering'", 'to': u"orm['notification.TaskHistory']"}),
