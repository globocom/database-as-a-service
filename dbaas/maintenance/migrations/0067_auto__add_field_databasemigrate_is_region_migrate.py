...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseMigrate.is_region_migrate'
        db.add_column(u'maintenance_databasemigrate', 'is_region_migrate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseMigrate.is_region_migrate'
        db.delete_column(u'maintenance_databasemigrate', 'is_region_migrate')
