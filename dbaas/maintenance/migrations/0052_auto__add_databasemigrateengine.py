...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseMigrateEngine'
        db.create_table(u'maintenance_databasemigrateengine', (
            ...
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasemigrateengine_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'engine_migrations', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_engine_migrations', to=orm['notification.TaskHistory'])),
            ('source_plan', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'database_engine_migrations_source', null=True, on_delete=models.SET_NULL, to=orm['physical.Plan'])),
            ('source_plan_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('target_plan', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'database_engine_migrations_target', null=True, on_delete=models.SET_NULL, to=orm['physical.Plan'])),
            ('target_plan_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseMigrateEngine'])


    def backwards(self, orm):
        # Deleting model 'DatabaseMigrateEngine'
        db.delete_table(u'maintenance_databasemigrateengine')
