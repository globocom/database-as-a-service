...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseDestroy'
        db.create_table(u'maintenance_databasedestroy', (
            ...
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases_destroy', to=orm['notification.TaskHistory'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'databases_destroy', null=True, on_delete=models.SET_NULL, to=orm['logical.Database'])),
            ('infra', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases_destroy', to=orm['physical.DatabaseInfra'])),
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'databases_destroy', null=True, on_delete=models.SET_NULL, to=orm['physical.Plan'])),
            ('plan_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('environment', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases_destroy', to=orm['physical.Environment'])),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases_destroy', to=orm['account.Team'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'databases_destroy', null=True, to=orm['logical.Project'])),
        ...
        db.send_create_signal(u'maintenance', ['DatabaseDestroy'])


    def backwards(self, orm):
        # Deleting model 'DatabaseDestroy'
        db.delete_table(u'maintenance_databasedestroy')
