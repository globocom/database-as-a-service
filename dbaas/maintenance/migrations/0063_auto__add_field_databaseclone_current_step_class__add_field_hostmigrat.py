...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseClone.current_step_class'
        db.add_column(u'maintenance_databaseclone', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HostMigrate.current_step_class'
        db.add_column(u'maintenance_hostmigrate', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseUpgrade.current_step_class'
        db.add_column(u'maintenance_databaseupgrade', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseChangeParameter.current_step_class'
        db.add_column(u'maintenance_databasechangeparameter', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RecreateSlave.current_step_class'
        db.add_column(u'maintenance_recreateslave', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UpdateSsl.current_step_class'
        db.add_column(u'maintenance_updatessl', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseMigrateEngine.current_step_class'
        db.add_column(u'maintenance_databasemigrateengine', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseReinstallVM.current_step_class'
        db.add_column(u'maintenance_databasereinstallvm', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseCreate.current_step_class'
        db.add_column(u'maintenance_databasecreate', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RemoveInstanceDatabase.current_step_class'
        db.add_column(u'maintenance_removeinstancedatabase', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseSetSSLNotRequired.current_step_class'
        db.add_column(u'maintenance_databasesetsslnotrequired', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AddInstancesToDatabase.current_step_class'
        db.add_column(u'maintenance_addinstancestodatabase', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FilerMigrate.current_step_class'
        db.add_column(u'maintenance_filermigrate', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseDestroy.current_step_class'
        db.add_column(u'maintenance_databasedestroy', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseChangePersistence.current_step_class'
        db.add_column(u'maintenance_databasechangepersistence', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseSetSSLRequired.current_step_class'
        db.add_column(u'maintenance_databasesetsslrequired', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseResize.current_step_class'
        db.add_column(u'maintenance_databaseresize', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RestartDatabase.current_step_class'
        db.add_column(u'maintenance_restartdatabase', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseRestore.current_step_class'
        db.add_column(u'maintenance_databaserestore', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseConfigureSSL.current_step_class'
        db.add_column(u'maintenance_databaseconfiguressl', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseMigrate.current_step_class'
        db.add_column(u'maintenance_databasemigrate', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseUpgradePatch.current_step_class'
        db.add_column(u'maintenance_databaseupgradepatch', 'current_step_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseClone.current_step_class'
        db.delete_column(u'maintenance_databaseclone', 'current_step_class')

        # Deleting field 'HostMigrate.current_step_class'
        db.delete_column(u'maintenance_hostmigrate', 'current_step_class')

        # Deleting field 'DatabaseUpgrade.current_step_class'
        db.delete_column(u'maintenance_databaseupgrade', 'current_step_class')

        # Deleting field 'DatabaseChangeParameter.current_step_class'
        db.delete_column(u'maintenance_databasechangeparameter', 'current_step_class')

        # Deleting field 'RecreateSlave.current_step_class'
        db.delete_column(u'maintenance_recreateslave', 'current_step_class')

        # Deleting field 'UpdateSsl.current_step_class'
        db.delete_column(u'maintenance_updatessl', 'current_step_class')

        # Deleting field 'DatabaseMigrateEngine.current_step_class'
        db.delete_column(u'maintenance_databasemigrateengine', 'current_step_class')

        # Deleting field 'DatabaseReinstallVM.current_step_class'
        db.delete_column(u'maintenance_databasereinstallvm', 'current_step_class')

        # Deleting field 'DatabaseCreate.current_step_class'
        db.delete_column(u'maintenance_databasecreate', 'current_step_class')

        # Deleting field 'RemoveInstanceDatabase.current_step_class'
        db.delete_column(u'maintenance_removeinstancedatabase', 'current_step_class')

        # Deleting field 'DatabaseSetSSLNotRequired.current_step_class'
        db.delete_column(u'maintenance_databasesetsslnotrequired', 'current_step_class')

        # Deleting field 'AddInstancesToDatabase.current_step_class'
        db.delete_column(u'maintenance_addinstancestodatabase', 'current_step_class')

        # Deleting field 'FilerMigrate.current_step_class'
        db.delete_column(u'maintenance_filermigrate', 'current_step_class')

        # Deleting field 'DatabaseDestroy.current_step_class'
        db.delete_column(u'maintenance_databasedestroy', 'current_step_class')

        # Deleting field 'DatabaseChangePersistence.current_step_class'
        db.delete_column(u'maintenance_databasechangepersistence', 'current_step_class')

        # Deleting field 'DatabaseSetSSLRequired.current_step_class'
        db.delete_column(u'maintenance_databasesetsslrequired', 'current_step_class')

        # Deleting field 'DatabaseResize.current_step_class'
        db.delete_column(u'maintenance_databaseresize', 'current_step_class')

        # Deleting field 'RestartDatabase.current_step_class'
        db.delete_column(u'maintenance_restartdatabase', 'current_step_class')

        # Deleting field 'DatabaseRestore.current_step_class'
        db.delete_column(u'maintenance_databaserestore', 'current_step_class')

        # Deleting field 'DatabaseConfigureSSL.current_step_class'
        db.delete_column(u'maintenance_databaseconfiguressl', 'current_step_class')

        # Deleting field 'DatabaseMigrate.current_step_class'
        db.delete_column(u'maintenance_databasemigrate', 'current_step_class')

        # Deleting field 'DatabaseUpgradePatch.current_step_class'
        db.delete_column(u'maintenance_databaseupgradepatch', 'current_step_class')
    ...
    models = {
        ...
        u'maintenance.databasechangepersistence': {
            'Meta': {'object_name': 'DatabaseChangePersistence'},
            'can_do_retry': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'current_step': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'current_step_class': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'database': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'change_persistence'", 'to': u"orm['logical.Database']"}),
            'finished_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source_plan': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'database_change_persistences_source'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Plan']"}),
            'started_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'target_plan': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'database_change_persistences_target'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Plan']"}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'database_change_persistence'", 'to': u"orm['notification.TaskHistory']"}),
            'task_schedule': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'maintenance_databasechangepersistence_related'", 'null': 'True', 'to': u"orm['maintenance.TaskSchedule']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'maintenance.databasecreate': {
            ...
            'pool': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'pools_create'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Pool']"}),
        ...
        u'maintenance.databasesetsslnotrequired': {
            'Meta': {'object_name': 'DatabaseSetSSLNotRequired'},
            'can_do_retry': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'current_step': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'current_step_class': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'database': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'set_not_require_ssl'", 'to': u"orm['logical.Database']"}),
            'finished_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'started_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'database_ssl_not_require'", 'to': u"orm['notification.TaskHistory']"}),
            'task_schedule': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'maintenance_databasesetsslnotrequired_related'", 'null': 'True', 'to': u"orm['maintenance.TaskSchedule']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'maintenance.databasesetsslrequired': {
            'Meta': {'object_name': 'DatabaseSetSSLRequired'},
            'can_do_retry': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'current_step': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'current_step_class': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'database': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'set_require_ssl'", 'to': u"orm['logical.Database']"}),
            'finished_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'started_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'database_ssl_require'", 'to': u"orm['notification.TaskHistory']"}),
        ...
        u'maintenance.hostmigrate': {
            ...
            'zone_origin': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'})
        },
        ...
        u'maintenance.removeinstancedatabase': {
            ...
            'finished_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'remove_instances_database_manager'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Instance']"}),
            'started_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
