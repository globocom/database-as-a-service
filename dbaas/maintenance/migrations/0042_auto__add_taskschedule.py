...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaskSchedule'
        db.create_table(u'maintenance_taskschedule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('method_path', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('scheduled_for', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ...
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'task_schedules', to=orm['logical.Database'])),
        ))
        db.send_create_signal(u'maintenance', ['TaskSchedule'])


    def backwards(self, orm):
        # Deleting model 'TaskSchedule'
        db.delete_table(u'maintenance_taskschedule')
