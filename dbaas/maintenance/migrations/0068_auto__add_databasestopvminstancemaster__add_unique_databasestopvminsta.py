...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseStopVMInstanceMaster'
        db.create_table(u'maintenance_databasestopvminstancemaster', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('database_stop', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_stop_instance', to=orm['maintenance.DatabaseStopDatabaseVM'])),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_stop_master', to=orm['physical.Instance'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseStopVMInstanceMaster'])

        # Adding unique constraint on 'DatabaseStopVMInstanceMaster', fields ['master', 'database_stop']
        db.create_unique(u'maintenance_databasestopvminstancemaster', ['master_id', 'database_stop_id'])

        # Adding model 'DatabaseStartDatabaseVM'
        db.create_table(u'maintenance_databasestartdatabasevm', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasestartdatabasevm_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('current_step_class', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_start_database_vm', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_start_database_vm', to=orm['notification.TaskHistory'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseStartDatabaseVM'])

        # Adding model 'DatabaseStopDatabaseVM'
        db.create_table(u'maintenance_databasestopdatabasevm', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('current_step', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ...
            ('finished_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('can_do_retry', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasestopdatabasevm_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('current_step_class', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_stop_database_vm', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_stop_database_vm', to=orm['notification.TaskHistory'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseStopDatabaseVM'])


    def backwards(self, orm):
        # Removing unique constraint on 'DatabaseStopVMInstanceMaster', fields ['master', 'database_stop']
        db.delete_unique(u'maintenance_databasestopvminstancemaster', ['master_id', 'database_stop_id'])

        # Deleting model 'DatabaseStopVMInstanceMaster'
        db.delete_table(u'maintenance_databasestopvminstancemaster')

        # Deleting model 'DatabaseStartDatabaseVM'
        db.delete_table(u'maintenance_databasestartdatabasevm')

        # Deleting model 'DatabaseStopDatabaseVM'
        db.delete_table(u'maintenance_databasestopdatabasevm')
