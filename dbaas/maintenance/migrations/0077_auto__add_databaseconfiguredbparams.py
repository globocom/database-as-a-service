...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseConfigureDBParams'
        db.create_table(u'maintenance_databaseconfiguredbparams', (
            ...
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databaseconfiguredbparams_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('current_step_class', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'dbparamsconfigures', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'dbparamsconfigures', to=orm['notification.TaskHistory'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseConfigureDBParams'])


    def backwards(self, orm):
        # Deleting model 'DatabaseConfigureDBParams'
        db.delete_table(u'maintenance_databaseconfiguredbparams')
    ...
    models = {
        ...
        u'maintenance.databaseconfiguredbparams': {
            ...
            'current_step': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'current_step_class': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'database': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'dbparamsconfigures'", 'to': u"orm['logical.Database']"}),
            'finished_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'started_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'dbparamsconfigures'", 'to': u"orm['notification.TaskHistory']"}),
