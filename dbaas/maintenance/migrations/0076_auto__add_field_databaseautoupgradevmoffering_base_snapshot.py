...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseAutoUpgradeVMOffering.base_snapshot'
        db.add_column(u'maintenance_databaseautoupgradevmoffering', 'base_snapshot',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name=u'database_autoupgrades', null=True, to=orm['backup.Snapshot']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseAutoUpgradeVMOffering.base_snapshot'
        db.delete_column(u'maintenance_databaseautoupgradevmoffering', 'base_snapshot_id')
