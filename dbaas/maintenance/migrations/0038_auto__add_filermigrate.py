...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FilerMigrate'
        db.create_table(u'maintenance_filermigrate', (
            ...
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'filer_migrate', to=orm['notification.TaskHistory'])),
            ('original_export_id', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'filer_migrate', to=orm['logical.Database'])),
        ))
        db.send_create_signal(u'maintenance', ['FilerMigrate'])


    def backwards(self, orm):
        # Deleting model 'FilerMigrate'
        db.delete_table(u'maintenance_filermigrate')
