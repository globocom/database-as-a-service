...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseChangePersistence'
        db.create_table(u'maintenance_databasechangepersistence', (
            ...
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasechangepersistence_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'change_persistence', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_change_persistence', to=orm['notification.TaskHistory'])),
            ('source_plan', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'database_change_persistences_source', null=True, on_delete=models.SET_NULL, to=orm['physical.Plan'])),
            ('target_plan', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'database_change_persistences_target', null=True, on_delete=models.SET_NULL, to=orm['physical.Plan'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseChangePersistence'])


    def backwards(self, orm):
        # Deleting model 'DatabaseChangePersistence'
        db.delete_table(u'maintenance_databasechangepersistence')
