...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseMigrate.migration_stage'
        db.add_column(u'maintenance_databasemigrate', 'migration_stage',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseMigrate.migration_stage'
        db.delete_column(u'maintenance_databasemigrate', 'migration_stage')
