...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HostMigrate.zone_origin'
        db.add_column(u'maintenance_hostmigrate', 'zone_origin',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HostMigrate.zone_origin'
        db.delete_column(u'maintenance_hostmigrate', 'zone_origin')
