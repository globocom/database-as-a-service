...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming column for 'DatabaseCreate.pool' to match new field type.
        db.rename_column(u'maintenance_databasecreate', 'pool', 'pool_id')
        # Changing field 'DatabaseCreate.pool'
        db.alter_column(u'maintenance_databasecreate', 'pool_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['physical.Pool']))
        # Adding index on 'DatabaseCreate', fields ['pool']
        db.create_index(u'maintenance_databasecreate', ['pool_id'])


    def backwards(self, orm):
        # Removing index on 'DatabaseCreate', fields ['pool']
        db.delete_index(u'maintenance_databasecreate', ['pool_id'])

        # Renaming column for 'DatabaseCreate.pool' to match new field type.
        db.rename_column(u'maintenance_databasecreate', 'pool_id', 'pool')
        # Changing field 'DatabaseCreate.pool'
        db.alter_column(u'maintenance_databasecreate', 'pool', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
