...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HostMigrate.snapshot'
        db.add_column(u'maintenance_hostmigrate', 'snapshot',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'snapshot_migrate', null=True, to=orm['backup.Snapshot']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HostMigrate.snapshot'
        db.delete_column(u'maintenance_hostmigrate', 'snapshot_id')
