...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'maintenance_databasemigratestandalonephase1', (
            ...
            ('target_plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'target_plan_migrate_sa_phase_1', null=True, to=orm['physical.Plan'], on_delete=models.SET_NULL, blank=True)),
            ('finished_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('target_environment', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'target_environment_migrate_sa_phase_1', null=True, to=orm['physical.Environment'], on_delete=models.SET_NULL, blank=True)),
            ('source_plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'source_plan_migrate_sa_phase_1', null=True, to=orm['physical.Plan'], on_delete=models.SET_NULL, blank=True)),
            ...
            ('target_offering', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'target_offering_migrate_sa_phase_1', null=True, to=orm['physical.Offering'], on_delete=models.SET_NULL, blank=True)),
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'maintenance_databasemigratestandalonephase1_related', null=True, to=orm['maintenance.TaskSchedule'], blank=True)),
            ('current_step', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('source_environment', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'source_environment_migrate_sa_phase_1', null=True, to=orm['physical.Environment'], on_delete=models.SET_NULL, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_offering', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'source_offering_migrate_sa_phase_1', null=True, to=orm['physical.Offering'], on_delete=models.SET_NULL, blank=True)),
        ))
        ...
        db.create_table(u'maintenance_databasemigratestandalonephase2', (
            ...
            ('target_plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'target_plan_migrate_sa_phase_2', null=True, to=orm['physical.Plan'], on_delete=models.SET_NULL, blank=True)),
            ('finished_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('target_environment', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'target_environment_migrate_sa_phase_2', null=True, to=orm['physical.Environment'], on_delete=models.SET_NULL, blank=True)),
            ('source_plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'source_plan_migrate_sa_phase_2', null=True, to=orm['physical.Plan'], on_delete=models.SET_NULL, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('can_do_retry', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('target_offering', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'target_offering_migrate_sa_phase_2', null=True, to=orm['physical.Offering'], on_delete=models.SET_NULL, blank=True)),
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'maintenance_databasemigratestandalonephase2_related', null=True, to=orm['maintenance.TaskSchedule'], blank=True)),
            ('current_step', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('source_environment', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'source_environment_migrate_sa_phase_2', null=True, to=orm['physical.Environment'], on_delete=models.SET_NULL, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_offering', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'source_offering_migrate_sa_phase_2', null=True, to=orm['physical.Offering'], on_delete=models.SET_NULL, blank=True)),
        ))
