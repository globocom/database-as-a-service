...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UpdateSsl'
        db.create_table(u'maintenance_updatessl', (
            ...
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'update_ssl_manager', to=orm['notification.TaskHistory'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'update_ssl_manager', to=orm['logical.Database'])),
        ))
        db.send_create_signal(u'maintenance', ['UpdateSsl'])


    def backwards(self, orm):
        # Deleting model 'UpdateSsl'
        db.delete_table(u'maintenance_updatessl')
