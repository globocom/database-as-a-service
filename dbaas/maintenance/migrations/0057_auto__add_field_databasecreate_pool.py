...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseCreate.pool'
        db.add_column(u'maintenance_databasecreate', 'pool',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseCreate.pool'
        db.delete_column(u'maintenance_databasecreate', 'pool')
    ...
    models = {
        ...
        u'maintenance.databasecreate': {
            ...
            'pool': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
