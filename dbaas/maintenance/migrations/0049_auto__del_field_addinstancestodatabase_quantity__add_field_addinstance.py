...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AddInstancesToDatabase.quantity'
        db.delete_column(u'maintenance_addinstancestodatabase', 'quantity')

        # Adding field 'AddInstancesToDatabase.number_of_instances'
        db.add_column(u'maintenance_addinstancestodatabase', 'number_of_instances',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'AddInstancesToDatabase.number_of_instances_before'
        db.add_column(u'maintenance_addinstancestodatabase', 'number_of_instances_before',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AddInstancesToDatabase.quantity'
        db.add_column(u'maintenance_addinstancestodatabase', 'quantity',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'AddInstancesToDatabase.number_of_instances'
        db.delete_column(u'maintenance_addinstancestodatabase', 'number_of_instances')

        # Deleting field 'AddInstancesToDatabase.number_of_instances_before'
        db.delete_column(u'maintenance_addinstancestodatabase', 'number_of_instances_before')
