...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseMigrateStandAlonePhase1'
        db.create_table(u'maintenance_databasemigratestandalonephase1', (
            ...
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasemigratestandalonephase1_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'db_migrate_sa_phase_1', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'task_db_migrate_sa_phase_1', to=orm['notification.TaskHistory'])),
            ('source_environment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'source_environment_migrate_sa_phase_1', null=True, on_delete=models.SET_NULL, to=orm['physical.Environment'])),
            ('target_environment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'target_environment_migrate_sa_phase_1', null=True, on_delete=models.SET_NULL, to=orm['physical.Environment'])),
            ('source_plan', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'source_plan_migrate_sa_phase_1', null=True, on_delete=models.SET_NULL, to=orm['physical.Plan'])),
            ('target_plan', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'target_plan_migrate_sa_phase_1', null=True, on_delete=models.SET_NULL, to=orm['physical.Plan'])),
            ('source_offering', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'source_offering_migrate_sa_phase_1', null=True, on_delete=models.SET_NULL, to=orm['physical.Offering'])),
            ('target_offering', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'target_offering_migrate_sa_phase_1', null=True, on_delete=models.SET_NULL, to=orm['physical.Offering'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseMigrateStandAlonePhase1'])

        # Adding model 'DatabaseMigrateStandAlonePhase2'
        db.create_table(u'maintenance_databasemigratestandalonephase2', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('current_step', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ...
            ('finished_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('can_do_retry', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasemigratestandalonephase2_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'db_migrate_sa_phase_2', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'task_db_migrate_sa_phase_2', to=orm['notification.TaskHistory'])),
            ('source_environment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'source_environment_migrate_sa_phase_2', null=True, on_delete=models.SET_NULL, to=orm['physical.Environment'])),
            ('target_environment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'target_environment_migrate_sa_phase_2', null=True, on_delete=models.SET_NULL, to=orm['physical.Environment'])),
            ('source_plan', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'source_plan_migrate_sa_phase_2', null=True, on_delete=models.SET_NULL, to=orm['physical.Plan'])),
            ('target_plan', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'target_plan_migrate_sa_phase_2', null=True, on_delete=models.SET_NULL, to=orm['physical.Plan'])),
            ('source_offering', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'source_offering_migrate_sa_phase_2', null=True, on_delete=models.SET_NULL, to=orm['physical.Offering'])),
            ('target_offering', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'target_offering_migrate_sa_phase_2', null=True, on_delete=models.SET_NULL, to=orm['physical.Offering'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseMigrateStandAlonePhase2'])


    def backwards(self, orm):
        # Deleting model 'DatabaseMigrateStandAlonePhase1'
        db.delete_table(u'maintenance_databasemigratestandalonephase1')

        # Deleting model 'DatabaseMigrateStandAlonePhase2'
        db.delete_table(u'maintenance_databasemigratestandalonephase2')
    ...
    models = {
        ...
        u'maintenance.databasemigratestandalonephase1': {
            'Meta': {'object_name': 'DatabaseMigrateStandAlonePhase1'},
            'can_do_retry': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'current_step': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'database': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'db_migrate_sa_phase_1'", 'to': u"orm['logical.Database']"}),
            'finished_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source_environment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'source_environment_migrate_sa_phase_1'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Environment']"}),
            'source_offering': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'source_offering_migrate_sa_phase_1'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Offering']"}),
            'source_plan': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'source_plan_migrate_sa_phase_1'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Plan']"}),
            'started_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'target_environment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'target_environment_migrate_sa_phase_1'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Environment']"}),
            'target_offering': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'target_offering_migrate_sa_phase_1'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Offering']"}),
            'target_plan': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'target_plan_migrate_sa_phase_1'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Plan']"}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'task_db_migrate_sa_phase_1'", 'to': u"orm['notification.TaskHistory']"}),
            'task_schedule': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'maintenance_databasemigratestandalonephase1_related'", 'null': 'True', 'to': u"orm['maintenance.TaskSchedule']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'maintenance.databasemigratestandalonephase2': {
            'Meta': {'object_name': 'DatabaseMigrateStandAlonePhase2'},
            'can_do_retry': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'current_step': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'database': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'db_migrate_sa_phase_2'", 'to': u"orm['logical.Database']"}),
            'finished_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source_environment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'source_environment_migrate_sa_phase_2'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Environment']"}),
            'source_offering': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'source_offering_migrate_sa_phase_2'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Offering']"}),
            'source_plan': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'source_plan_migrate_sa_phase_2'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Plan']"}),
            'started_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'target_environment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'target_environment_migrate_sa_phase_2'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Environment']"}),
            'target_offering': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'target_offering_migrate_sa_phase_2'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Offering']"}),
            'target_plan': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'target_plan_migrate_sa_phase_2'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.Plan']"}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'task_db_migrate_sa_phase_2'", 'to': u"orm['notification.TaskHistory']"}),
            'task_schedule': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'maintenance_databasemigratestandalonephase2_related'", 'null': 'True', 'to': u"orm['maintenance.TaskSchedule']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
