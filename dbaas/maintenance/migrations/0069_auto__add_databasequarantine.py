...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseQuarantine'
        db.create_table(u'maintenance_databasequarantine', (
            ...
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasequarantine_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('current_step_class', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases_quarantine', to=orm['notification.TaskHistory'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'databases_quarantine', null=True, on_delete=models.SET_NULL, to=orm['logical.Database'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('user', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('undo', self.gf('django.db.models.fields.BooleanField')()),
            ('infra', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases_quarantine', to=orm['physical.DatabaseInfra'])),
        ...
        db.send_create_signal(u'maintenance', ['DatabaseQuarantine'])


    def backwards(self, orm):
        # Deleting model 'DatabaseQuarantine'
        db.delete_table(u'maintenance_databasequarantine')
