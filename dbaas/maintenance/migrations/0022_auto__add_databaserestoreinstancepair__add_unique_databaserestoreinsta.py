...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseRestoreInstancePair'
        db.create_table(u'maintenance_databaserestoreinstancepair', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'restore_master', to=orm['physical.Instance'])),
            ('slave', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'restore_slave', to=orm['physical.Instance'])),
            ('restore', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'restore_instances', to=orm['maintenance.DatabaseRestore'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseRestoreInstancePair'])

        # Adding unique constraint on 'DatabaseRestoreInstancePair', fields ['master', 'slave', 'restore']
        db.create_unique(u'maintenance_databaserestoreinstancepair', ['master_id', 'slave_id', 'restore_id'])

        # Adding model 'DatabaseRestore'
        db.create_table(u'maintenance_databaserestore', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_restore', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_restore', to=orm['notification.TaskHistory'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_restore', to=orm['backup.BackupGroup'])),
            ('new_group', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'database_restore_new', null=True, to=orm['backup.BackupGroup'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseRestore'])


    def backwards(self, orm):
        # Removing unique constraint on 'DatabaseRestoreInstancePair', fields ['master', 'slave', 'restore']
        db.delete_unique(u'maintenance_databaserestoreinstancepair', ['master_id', 'slave_id', 'restore_id'])

        # Deleting model 'DatabaseRestoreInstancePair'
        db.delete_table(u'maintenance_databaserestoreinstancepair')

        # Deleting model 'DatabaseRestore'
        db.delete_table(u'maintenance_databaserestore')
