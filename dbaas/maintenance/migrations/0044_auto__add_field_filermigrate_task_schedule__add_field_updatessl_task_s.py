...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilerMigrate.task_schedule'
        db.add_column(u'maintenance_filermigrate', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_filermigrate_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'UpdateSsl.task_schedule'
        db.add_column(u'maintenance_updatessl', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_updatessl_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'DatabaseCreate.task_schedule'
        db.add_column(u'maintenance_databasecreate', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasecreate_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'DatabaseUpgradePatch.task_schedule'
        db.add_column(u'maintenance_databaseupgradepatch', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databaseupgradepatch_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'DatabaseResize.task_schedule'
        db.add_column(u'maintenance_databaseresize', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databaseresize_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'HostMigrate.task_schedule'
        db.add_column(u'maintenance_hostmigrate', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_hostmigrate_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'DatabaseRestore.task_schedule'
        db.add_column(u'maintenance_databaserestore', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databaserestore_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'DatabaseConfigureSSL.task_schedule'
        db.add_column(u'maintenance_databaseconfiguressl', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databaseconfiguressl_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'DatabaseUpgrade.task_schedule'
        db.add_column(u'maintenance_databaseupgrade', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databaseupgrade_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'DatabaseReinstallVM.task_schedule'
        db.add_column(u'maintenance_databasereinstallvm', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasereinstallvm_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'DatabaseMigrate.task_schedule'
        db.add_column(u'maintenance_databasemigrate', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasemigrate_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'DatabaseChangeParameter.task_schedule'
        db.add_column(u'maintenance_databasechangeparameter', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasechangeparameter_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'DatabaseDestroy.task_schedule'
        db.add_column(u'maintenance_databasedestroy', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasedestroy_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)

        # Adding field 'RecreateSlave.task_schedule'
        db.add_column(u'maintenance_recreateslave', 'task_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_recreateslave_related', null=True, to=orm['maintenance.TaskSchedule']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilerMigrate.task_schedule'
        db.delete_column(u'maintenance_filermigrate', 'task_schedule_id')

        # Deleting field 'UpdateSsl.task_schedule'
        db.delete_column(u'maintenance_updatessl', 'task_schedule_id')

        # Deleting field 'DatabaseCreate.task_schedule'
        db.delete_column(u'maintenance_databasecreate', 'task_schedule_id')

        # Deleting field 'DatabaseUpgradePatch.task_schedule'
        db.delete_column(u'maintenance_databaseupgradepatch', 'task_schedule_id')

        # Deleting field 'DatabaseResize.task_schedule'
        db.delete_column(u'maintenance_databaseresize', 'task_schedule_id')

        # Deleting field 'HostMigrate.task_schedule'
        db.delete_column(u'maintenance_hostmigrate', 'task_schedule_id')

        # Deleting field 'DatabaseRestore.task_schedule'
        db.delete_column(u'maintenance_databaserestore', 'task_schedule_id')

        # Deleting field 'DatabaseConfigureSSL.task_schedule'
        db.delete_column(u'maintenance_databaseconfiguressl', 'task_schedule_id')

        # Deleting field 'DatabaseUpgrade.task_schedule'
        db.delete_column(u'maintenance_databaseupgrade', 'task_schedule_id')

        # Deleting field 'DatabaseReinstallVM.task_schedule'
        db.delete_column(u'maintenance_databasereinstallvm', 'task_schedule_id')

        # Deleting field 'DatabaseMigrate.task_schedule'
        db.delete_column(u'maintenance_databasemigrate', 'task_schedule_id')

        # Deleting field 'DatabaseChangeParameter.task_schedule'
        db.delete_column(u'maintenance_databasechangeparameter', 'task_schedule_id')

        # Deleting field 'DatabaseDestroy.task_schedule'
        db.delete_column(u'maintenance_databasedestroy', 'task_schedule_id')

        # Deleting field 'RecreateSlave.task_schedule'
        db.delete_column(u'maintenance_recreateslave', 'task_schedule_id')
