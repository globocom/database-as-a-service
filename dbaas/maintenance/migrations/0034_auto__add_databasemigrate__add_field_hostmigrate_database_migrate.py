...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseMigrate'
        db.create_table(u'maintenance_databasemigrate', (
            ...
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_migrate', to=orm['notification.TaskHistory'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_migrate', to=orm['logical.Database'])),
            ('environment', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_migrate', to=orm['physical.Environment'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseMigrate'])

        # Adding field 'HostMigrate.database_migrate'
        db.add_column(u'maintenance_hostmigrate', 'database_migrate',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'hosts', null=True, to=orm['maintenance.DatabaseMigrate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DatabaseMigrate'
        db.delete_table(u'maintenance_databasemigrate')

        # Deleting field 'HostMigrate.database_migrate'
        db.delete_column(u'maintenance_hostmigrate', 'database_migrate_id')
