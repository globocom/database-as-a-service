...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'maintenance_databasemigrateengine', (
            ('current_database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'engine_migrations', to=orm['logical.Database'])),
            (u'databaseupgrade_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['maintenance.DatabaseUpgrade'], unique=True, primary_key=True)),
        ))
