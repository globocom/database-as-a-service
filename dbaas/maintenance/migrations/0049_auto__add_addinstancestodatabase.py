...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AddInstancesToDatabase'
        db.create_table(u'maintenance_addinstancestodatabase', (
            ...
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_addinstancestodatabase_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'add_instances_to_database_manager', to=orm['notification.TaskHistory'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'add_instances_to_database_manager', to=orm['logical.Database'])),
            ('number_of_instances', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('number_of_instances_before', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
        ))
        db.send_create_signal(u'maintenance', ['AddInstancesToDatabase'])


    def backwards(self, orm):
        # Deleting model 'AddInstancesToDatabase'
        db.delete_table(u'maintenance_addinstancestodatabase')
