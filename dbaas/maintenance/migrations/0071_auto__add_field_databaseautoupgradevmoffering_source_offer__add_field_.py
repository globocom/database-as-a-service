...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseAutoUpgradeVMOffering.source_offer'
        db.add_column(u'maintenance_databaseautoupgradevmoffering', 'source_offer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'database_autoupgrades_source', null=True, on_delete=models.SET_NULL, to=orm['physical.Offering']),
                      keep_default=False)

        # Adding field 'DatabaseAutoUpgradeVMOffering.target_offer'
        db.add_column(u'maintenance_databaseautoupgradevmoffering', 'target_offer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'database_autoupgrades_target', null=True, on_delete=models.SET_NULL, to=orm['physical.Offering']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseAutoUpgradeVMOffering.source_offer'
        db.delete_column(u'maintenance_databaseautoupgradevmoffering', 'source_offer_id')

        # Deleting field 'DatabaseAutoUpgradeVMOffering.target_offer'
        db.delete_column(u'maintenance_databaseautoupgradevmoffering', 'target_offer_id')
