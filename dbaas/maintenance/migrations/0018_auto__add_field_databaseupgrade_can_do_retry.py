...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseUpgrade.can_do_retry'
        db.add_column(u'maintenance_databaseupgrade', 'can_do_retry',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseUpgrade.can_do_retry'
        db.delete_column(u'maintenance_databaseupgrade', 'can_do_retry')
