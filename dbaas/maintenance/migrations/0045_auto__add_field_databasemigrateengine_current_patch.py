...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseMigrateEngine.current_patch'
        db.add_column(u'maintenance_databasemigrateengine', 'current_patch',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'database_migrate_engine_patches', null=True, on_delete=models.SET_NULL, to=orm['physical.EnginePatch']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseMigrateEngine.current_patch'
        db.delete_column(u'maintenance_databasemigrateengine', 'current_patch_id')
    ...
    models = {
        ...
        u'maintenance.databasemigrateengine': {
            ...
            'current_patch': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'database_migrate_engine_patches'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['physical.EnginePatch']"}),
