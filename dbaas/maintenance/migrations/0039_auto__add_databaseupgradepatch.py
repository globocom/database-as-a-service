...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseUpgradePatch'
        db.create_table(u'maintenance_databaseupgradepatch', (
            ...
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'minorupgrades', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_minor_upgrades', to=orm['notification.TaskHistory'])),
            ('source_patch', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'database_minor_upgrades_source', null=True, on_delete=models.SET_NULL, to=orm['physical.EnginePatch'])),
            ('source_patch_full_version', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('target_patch', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'database_minor_upgrades_target', null=True, on_delete=models.SET_NULL, to=orm['physical.EnginePatch'])),
            ('target_patch_full_version', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseUpgradePatch'])


    def backwards(self, orm):
        # Deleting model 'DatabaseUpgradePatch'
        db.delete_table(u'maintenance_databaseupgradepatch')
    ...
    models = {
        ...
        u'maintenance.databaseupgradepatch': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'current_step': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'database': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'minorupgrades'", 'to': u"orm['logical.Database']"}),
            'finished_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'database_minor_upgrades'", 'to': u"orm['notification.TaskHistory']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
