...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseUpgrade'
        db.create_table(u'maintenance_databaseupgrade', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'upgrades', to=orm['logical.Database'])),
            ('source_plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_upgrades_source', to=orm['physical.Plan'])),
            ('target_plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_upgrades_target', to=orm['physical.Plan'])),
            ('current_step', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_upgrades', to=orm['notification.TaskHistory'])),
        ...
        db.send_create_signal(u'maintenance', ['DatabaseUpgrade'])


    def backwards(self, orm):
        # Deleting model 'DatabaseUpgrade'
        db.delete_table(u'maintenance_databaseupgrade')
