...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RemoveInstanceDatabase.instance'
        db.alter_column(u'maintenance_removeinstancedatabase', 'instance_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['physical.Instance']))

    def backwards(self, orm):

        # Changing field 'RemoveInstanceDatabase.instance'
        db.alter_column(u'maintenance_removeinstancedatabase', 'instance_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['physical.Instance']))
