...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DatabaseAutoUpgradeVMOffering.source_offer_name'
        db.delete_column(u'maintenance_databaseautoupgradevmoffering', 'source_offer_name')

        # Deleting field 'DatabaseAutoUpgradeVMOffering.target_offer_name'
        db.delete_column(u'maintenance_databaseautoupgradevmoffering', 'target_offer_name')


    def backwards(self, orm):
        # Adding field 'DatabaseAutoUpgradeVMOffering.source_offer_name'
        db.add_column(u'maintenance_databaseautoupgradevmoffering', 'source_offer_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseAutoUpgradeVMOffering.target_offer_name'
        db.add_column(u'maintenance_databaseautoupgradevmoffering', 'target_offer_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
