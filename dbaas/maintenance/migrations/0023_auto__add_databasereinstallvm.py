...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseReinstallVM'
        db.create_table(u'maintenance_databasereinstallvm', (
            ...
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'reinstall_vm', to=orm['logical.Database'])),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_reinstall_vm', to=orm['physical.Instance'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_reinsgtall_vm', to=orm['notification.TaskHistory'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseReinstallVM'])


    def backwards(self, orm):
        # Deleting model 'DatabaseReinstallVM'
        db.delete_table(u'maintenance_databasereinstallvm')
