...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseUpgradeDiskType'
        db.create_table(u'maintenance_databaseupgradedisktype', (
            ...
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databaseupgradedisktype_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('current_step_class', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_upgrade_disk_type', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_upgrade_disk_type', to=orm['notification.TaskHistory'])),
            ('disk_offering_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_upgrade_disk_type', to=orm['physical.DiskOfferingType'])),
            ('origin_disk_offering_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_upgrade_disk_type_new', to=orm['physical.DiskOfferingType'])),
            ('instance_snapshot', self.gf('django.db.models.fields.TextField')(default=u'{}')),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseUpgradeDiskType'])


    def backwards(self, orm):
        # Deleting model 'DatabaseUpgradeDiskType'
        db.delete_table(u'maintenance_databaseupgradedisktype')
    ...
    models = {
        ...
        u'maintenance.databaseupgradedisktype': {
            ...
            'finished_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance_snapshot': ('django.db.models.fields.TextField', [], {'default': "u'{}'"}),
