...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseAutoUpgradeVMOffering.number_of_instances'
        db.add_column(u'maintenance_databaseautoupgradevmoffering', 'number_of_instances',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'DatabaseAutoUpgradeVMOffering.number_of_instances_before'
        db.add_column(u'maintenance_databaseautoupgradevmoffering', 'number_of_instances_before',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=3, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseAutoUpgradeVMOffering.number_of_instances'
        db.delete_column(u'maintenance_databaseautoupgradevmoffering', 'number_of_instances')

        # Deleting field 'DatabaseAutoUpgradeVMOffering.number_of_instances_before'
        db.delete_column(u'maintenance_databaseautoupgradevmoffering', 'number_of_instances_before')
