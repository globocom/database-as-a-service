...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DatabaseStopDatabaseVMInstanceMaster', fields ['master', 'database_stop']
        db.delete_unique(u'maintenance_databasestopdatabasevminstancemaster', ['master_id', 'database_stop_id'])

        # Deleting model 'DatabaseStopDatabaseVMInstanceMaster'
        db.delete_table(u'maintenance_databasestopdatabasevminstancemaster')
    ...
    def backwards(self, orm):
        ...
        # Adding model 'DatabaseStopDatabaseVMInstanceMaster'
        db.create_table(u'maintenance_databasestopdatabasevminstancemaster', (
            ('database_stop', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_stop_instance', to=orm['maintenance.DatabaseStopDatabaseVM'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_stop_master', to=orm['physical.Instance'])),
        ...
        db.send_create_signal(u'maintenance', ['DatabaseStopDatabaseVMInstanceMaster'])

        # Adding unique constraint on 'DatabaseStopDatabaseVMInstanceMaster', fields ['master', 'database_stop']
        db.create_unique(u'maintenance_databasestopdatabasevminstancemaster', ['master_id', 'database_stop_id'])
