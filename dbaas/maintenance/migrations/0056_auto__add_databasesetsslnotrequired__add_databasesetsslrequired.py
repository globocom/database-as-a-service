...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseSetSSLNotRequired'
        db.create_table(u'maintenance_databasesetsslnotrequired', (
            ...
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasesetsslnotrequired_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'set_not_require_ssl', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_ssl_not_require', to=orm['notification.TaskHistory'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseSetSSLNotRequired'])

        # Adding model 'DatabaseSetSSLRequired'
        db.create_table(u'maintenance_databasesetsslrequired', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('current_step', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ...
            ('finished_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('can_do_retry', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databasesetsslrequired_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'set_require_ssl', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_ssl_require', to=orm['notification.TaskHistory'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseSetSSLRequired'])


    def backwards(self, orm):
        # Deleting model 'DatabaseSetSSLNotRequired'
        db.delete_table(u'maintenance_databasesetsslnotrequired')

        # Deleting model 'DatabaseSetSSLRequired'
        db.delete_table(u'maintenance_databasesetsslrequired')
