...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseDestroy.instances'
        db.add_column(u'maintenance_databasedestroy', 'instances',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseDestroy.instances'
        db.delete_column(u'maintenance_databasedestroy', 'instances')
