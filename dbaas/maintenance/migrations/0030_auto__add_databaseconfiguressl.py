...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseConfigureSSL'
        db.create_table(u'maintenance_databaseconfiguressl', (
            ...
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'configure_ssl', to=orm['logical.Database'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_configure_ssl', to=orm['notification.TaskHistory'])),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseConfigureSSL'])


    def backwards(self, orm):
        # Deleting model 'DatabaseConfigureSSL'
        db.delete_table(u'maintenance_databaseconfiguressl')
