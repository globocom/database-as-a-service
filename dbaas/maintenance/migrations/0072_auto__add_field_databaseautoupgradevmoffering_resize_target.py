...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseAutoUpgradeVMOffering.resize_target'
        db.add_column(u'maintenance_databaseautoupgradevmoffering', 'resize_target',
                      self.gf('django.db.models.fields.CharField')(default=u'cpu', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseAutoUpgradeVMOffering.resize_target'
        db.delete_column(u'maintenance_databaseautoupgradevmoffering', 'resize_target')
