...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseCreate'
        db.create_table(u'maintenance_databasecreate', (
            ...
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'create_database', to=orm['notification.TaskHistory'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'databases_create', null=True, to=orm['logical.Database'])),
            ('infra', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases_create', to=orm['physical.DatabaseInfra'])),
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases_create', to=orm['physical.Plan'])),
            ('environment', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases_create', to=orm['physical.Environment'])),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases_create', to=orm['account.Team'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'databases_create', null=True, to=orm['logical.Project'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('subscribe_to_email_events', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal(u'maintenance', ['DatabaseCreate'])


    def backwards(self, orm):
        # Deleting model 'DatabaseCreate'
        db.delete_table(u'maintenance_databasecreate')
