...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'maintenance_databasemigrateengine', 'current_patch',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'database_migrate_engine_patches', null=True, to=orm['physical.EnginePatch'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
