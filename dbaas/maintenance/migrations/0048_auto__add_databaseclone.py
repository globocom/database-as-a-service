...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseClone'
        db.create_table(u'maintenance_databaseclone', (
            ...
            ('task_schedule', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maintenance_databaseclone_related', null=True, to=orm['maintenance.TaskSchedule'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'create_clone', to=orm['notification.TaskHistory'])),
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'databases_clone', null=True, on_delete=models.SET_NULL, to=orm['logical.Database'])),
            ('origin_database', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'origin_databases_clone', null=True, on_delete=models.SET_NULL, to=orm['logical.Database'])),
            ('infra', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases_clone', to=orm['physical.DatabaseInfra'])),
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'databases_clone', null=True, on_delete=models.SET_NULL, to=orm['physical.Plan'])),
            ('environment', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databases_clone', to=orm['physical.Environment'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('user', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'maintenance', ['DatabaseClone'])


    def backwards(self, orm):
        # Deleting model 'DatabaseClone'
        db.delete_table(u'maintenance_databaseclone')
