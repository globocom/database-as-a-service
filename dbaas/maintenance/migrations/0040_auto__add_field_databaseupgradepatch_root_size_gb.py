...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseUpgradePatch.root_size_gb'
        db.add_column(u'maintenance_databaseupgradepatch', 'root_size_gb',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseUpgradePatch.root_size_gb'
        db.delete_column(u'maintenance_databaseupgradepatch', 'root_size_gb')
