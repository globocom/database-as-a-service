...
class DatabaseMigrateStandAlonePhase2Admin(DatabaseMaintenanceTaskAdmin):
    ...
    list_display = (
        "database", "source_environment", "target_environment", "source_plan",
        "target_plan", "source_offering", "target_offering", "current_step", 
