...
class UpdateSslAdmin(DatabaseMaintenanceTaskAdmin):
    ...
    def maintenance_action(self, maintenance_task):
        ...
        url_retry = "/admin/maintenance/updatessl/{}/retry/".format(
            maintenance_task.id
        )
        html_retry = (
    ...
    def check_status(self, request, step_manager, operation):
        ...
        return success, HttpResponseRedirect(
            reverse(
                'admin:maintenance_updatessl_change',
