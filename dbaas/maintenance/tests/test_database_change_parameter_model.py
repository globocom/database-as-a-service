...
class DatabaseChangeParameterTestCase(TestCase):
    ...
    def test_update_step(self):
        ...
        self.assertEqual(self.database_change_parameter.status, DatabaseChangeParameter.WAITING)
        ...
        self.assertEqual(self.database_change_parameter.status, DatabaseChangeParameter.RUNNING)
        ...
        self.assertEqual(self.database_change_parameter.started_at, started_at_first)
        self.assertEqual(self.database_change_parameter.status, DatabaseChangeParameter.RUNNING)
    ...
    def test_status_error(self):
        ...
        self.assertEqual(self.database_change_parameter.status, DatabaseChangeParameter.ERROR)
    ...
    def test_status_success(self):
        ...
        self.assertIsNotNone(self.database_change_parameter.finished_at)
        self.assertEqual(self.database_change_parameter.status, DatabaseChangeParameter.SUCCESS)
    ...
    def test_cannot_do_retry(self):
        ...
        old_change_parameter = DatabaseChangeParameter.objects.get(id=self.database_change_parameter.id)
