...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Snapshot', fields ['database_name']
        db.create_index(u'backup_snapshot', ['database_name'])


    def backwards(self, orm):
        # Removing index on 'Snapshot', fields ['database_name']
        db.delete_index(u'backup_snapshot', ['database_name'])
