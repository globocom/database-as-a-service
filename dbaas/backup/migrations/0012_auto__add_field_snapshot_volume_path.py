...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snapshot.volume_path'
        db.add_column(u'backup_snapshot', 'volume_path',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snapshot.volume_path'
        db.delete_column(u'backup_snapshot', 'volume_path')
