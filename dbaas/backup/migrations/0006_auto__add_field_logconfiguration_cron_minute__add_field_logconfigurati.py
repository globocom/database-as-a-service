...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogConfiguration.cron_minute'
        db.add_column(u'backup_logconfiguration', 'cron_minute',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)

        # Adding field 'LogConfiguration.cron_hour'
        db.add_column(u'backup_logconfiguration', 'cron_hour',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogConfiguration.cron_minute'
        db.delete_column(u'backup_logconfiguration', 'cron_minute')

        # Deleting field 'LogConfiguration.cron_hour'
        db.delete_column(u'backup_logconfiguration', 'cron_hour')
