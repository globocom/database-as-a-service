...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snapshot.persistent'
        db.add_column(u'backup_snapshot', 'persistent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snapshot.persistent'
        db.delete_column(u'backup_snapshot', 'persistent')
