...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snapshot.is_automatic'
        db.add_column(u'backup_snapshot', 'is_automatic',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snapshot.is_automatic'
        db.delete_column(u'backup_snapshot', 'is_automatic')
