...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'flipperfox_migration.databaseflipperfoxmigration': {
            'Meta': {'object_name': 'DatabaseFlipperFoxMigration'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'current_step': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'database': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'flipperfoxmigration'", 'unique': 'True', 'to': u"orm['logical.Database']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'flipperfox_migration.databaseflipperfoxmigrationdetail': {
            'Meta': {'unique_together': "((u'database_flipperfox_migration', u'step', u'scheduled_for'),)", 'object_name': 'DatabaseFlipperFoxMigrationDetail'},
            'celery_task_id': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'database_flipperfox_migration': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'details'", 'to': u"orm['flipperfox_migration.DatabaseFlipperFoxMigration']"}),
            'finished_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_migration_up': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
