...
from workflow.steps.mysql.util import build_start_mysql_statsd_script
...
class StartMySQLStasD(BaseStep):
    ...
    def do(self, workflow_dict):
        try:
            for source_host in workflow_dict['source_hosts']:
                ...
                script += build_start_mysql_statsd_script()
    ...
    def undo(self, workflow_dict):
        ...
        try:
            LOG.info('Rollback starting mysql_statsd - nothing to do')
