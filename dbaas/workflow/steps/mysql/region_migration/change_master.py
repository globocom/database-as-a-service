...
class ChangeMaster(BaseStep):
    ...
    def do(self, workflow_dict):
        try:
            target_instances = workflow_dict['databaseinfra'].instances.filter(future_instance=None)
            ...
            master_log_file, master_log_pos = get_replication_info(target_instance_one)
            ...
            master_log_file, master_log_pos = get_replication_info(target_instance_zero)
    ...
    def undo(self, workflow_dict):
        ...
        try:
            ...
            master_log_file, master_log_pos = get_replication_info(source_instance_zero)
            change_master_to(instance=target_instance_zero,
