...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IntegrationType'
        db.create_table(u'credentials_integrationtype', (
        ...
        db.send_create_signal(u'credentials', ['IntegrationType'])
    ...
    def backwards(self, orm):
        # Deleting model 'IntegrationType'
        db.delete_table(u'credentials_integrationtype')
