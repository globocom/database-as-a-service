...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntegrationCredential.team'
        db.add_column(u'credentials_integrationcredential', 'team',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IntegrationCredential.team'
        db.delete_column(u'credentials_integrationcredential', 'team')
