...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HostAttr.nfsaas_path'
        db.add_column(u'nfsaas_hostattr', 'nfsaas_path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HostAttr.nfsaas_path'
        db.delete_column(u'nfsaas_hostattr', 'nfsaas_path')
