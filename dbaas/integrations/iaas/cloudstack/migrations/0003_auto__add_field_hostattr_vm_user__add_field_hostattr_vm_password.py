...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HostAttr.vm_user'
        db.add_column(u'cloudstack_hostattr', 'vm_user',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HostAttr.vm_password'
        db.add_column(u'cloudstack_hostattr', 'vm_password',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HostAttr.vm_user'
        db.delete_column(u'cloudstack_hostattr', 'vm_user')

        # Deleting field 'HostAttr.vm_password'
        db.delete_column(u'cloudstack_hostattr', 'vm_password')
    ...
    models = {
        u'cloudstack.hostattr': {
            ...
            'vm_password': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
