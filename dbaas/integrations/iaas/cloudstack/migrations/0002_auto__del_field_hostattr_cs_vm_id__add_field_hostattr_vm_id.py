...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HostAttr.cs_vm_id'
        db.delete_column(u'cloudstack_hostattr', 'cs_vm_id')

        # Adding field 'HostAttr.vm_id'
        db.add_column(u'cloudstack_hostattr', 'vm_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HostAttr.cs_vm_id'
        db.add_column(u'cloudstack_hostattr', 'cs_vm_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'HostAttr.vm_id'
        db.delete_column(u'cloudstack_hostattr', 'vm_id')
