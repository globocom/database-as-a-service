...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnalyzeRepository.volume_alarm'
        db.add_column(u'analyzing_analyzerepository', 'volume_alarm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnalyzeRepository.volume_alarm'
        db.delete_column(u'analyzing_analyzerepository', 'volume_alarm')
