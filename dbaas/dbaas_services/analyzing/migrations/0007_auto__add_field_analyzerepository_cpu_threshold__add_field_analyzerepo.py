...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnalyzeRepository.cpu_threshold'
        db.add_column(u'analyzing_analyzerepository', 'cpu_threshold',
                      self.gf('django.db.models.fields.IntegerField')(default=50),
                      keep_default=False)

        # Adding field 'AnalyzeRepository.memory_threshold'
        db.add_column(u'analyzing_analyzerepository', 'memory_threshold',
                      self.gf('django.db.models.fields.IntegerField')(default=50),
                      keep_default=False)

        # Adding field 'AnalyzeRepository.volume_threshold'
        db.add_column(u'analyzing_analyzerepository', 'volume_threshold',
                      self.gf('django.db.models.fields.IntegerField')(default=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnalyzeRepository.cpu_threshold'
        db.delete_column(u'analyzing_analyzerepository', 'cpu_threshold')

        # Deleting field 'AnalyzeRepository.memory_threshold'
        db.delete_column(u'analyzing_analyzerepository', 'memory_threshold')

        # Deleting field 'AnalyzeRepository.volume_threshold'
        db.delete_column(u'analyzing_analyzerepository', 'volume_threshold')
