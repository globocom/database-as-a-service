...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExecutionPlan.threshold_repository_attr'
        db.add_column(u'analyzing_executionplan', 'threshold_repository_attr',
                      self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=150),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExecutionPlan.threshold_repository_attr'
        db.delete_column(u'analyzing_executionplan', 'threshold_repository_attr')
