...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExecutionPlan.minimum_value'
        db.add_column(u'analyzing_executionplan', 'minimum_value',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExecutionPlan.minimum_value'
        db.delete_column(u'analyzing_executionplan', 'minimum_value')
